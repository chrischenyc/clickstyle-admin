...
import { Container, Form, Checkbox, Button, Modal, List } from 'semantic-ui-react';
    ...
    <Container className="margin-top-35 margin-bottom-35">
      ...
      >
        ...
        <Form.Field>
          <Checkbox
            name="print"
            label="also mark new coupons as printed"
        ...
        generatedCouponCodes.length > 0 && (
          <Modal size="small" closeOnDimmerClick={false} closeIcon={false} open>
            ...
            <Modal.Content scrolling>
              <List>
                {generatedCouponCodes.map(code => <List.Item key={code}>{code}</List.Item>)}
              </List>
            </Modal.Content>
            <Modal.Actions>
